      ...
      <i-col :md="24" :lg="24" style="margin-bottom: 10px;">
        <Card :bordered="false" dis-hover>
          ...
          <div class="search-con search-con-top">
            ...
            <slot name="new_btn">
              <Button type="info" @click="handlerDB('', 'post', '添加数据库')" class="search-btn">添加数据库</Button>
            </slot>
            ...
            <Button type="success" class="search-btn" @click="exportData(2)">
              <Icon type="ios-download-outline"></Icon>
              导出数据
            </Button>
            <Detail :dialog="dialog2" :formData="formValidate" @e-close="closeModal"></Detail>
            <MultiAdd :dialog="multi_dialog" :formData="formData_multi" @e-update="getDBList"
                      @e-close="closeMultiModal"></MultiAdd>
          </div>
          <Table size="small" ref="selection" :columns="columns" :data="tableData"
                 @on-selection-change="handleSelectChange"></Table>
          <div style="margin: 10px; overflow: hidden">
            <div style="float: left;">
              <Page :total="pageTotal" :current="pageNum" :page-size="pageSize" :page-size-opts=[15,25,50,100]
                    show-sizer
          ...
          <Modal v-model="modalMap1.modalVisible" :title="modalMap1.modalTitle" :loading=true :footer-hide=true
            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="120">
              ...
              <FormItem label="密码" prop="db_pwd">
                <Input v-model="formValidate.db_pwd" :maxlength=100 type="password" password
...
<script>
  ...
  import {getErrorLog} from '@/api/cmdb2/server.js'
