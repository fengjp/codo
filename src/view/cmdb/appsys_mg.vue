      ...
      <Col span="19">
        <Card :bordered="false">
          ...
          <Form label-position="right" :label-width="130" inline label-colon=":">
            <FormItem label="系统名称" style="width: 30%">
              <span style="font-size: 12px;">{{tableData[0].sys_name}}</span>
            </FormItem>
            <FormItem label="版本号" style="width: 30%">
              <span style="font-size: 12px;">{{tableData[0].sys_version}}</span>
            </FormItem>
            <FormItem label="上线时间" style="width: 30%">
              <span style="font-size: 12px;">{{tableData[0].online_time}}</span>
            </FormItem>
            <FormItem label="开发单位" style="width: 30%">
              <span style="font-size: 12px;">{{tableData[0].development}}</span>
            </FormItem>
            <FormItem label="开发单位联系人" style="width: 30%">
              <span style="font-size: 12px;">{{tableData[0].development_contact}}</span>
            </FormItem>
            <FormItem label="开发单位联系电话" style="width: 30%">
              <span style="font-size: 12px;">{{tableData[0].development_phone}}</span>
            </FormItem>
            <FormItem label="系统负责人" style="width: 30%">
              <a @click="handleDetail(tableData[0].sys_manager_list)">查看负责人</a>
            </FormItem>
            <FormItem label="文档" style="width: 30%">
              <a @click="handleDocxDetail(tableData[0].sys_docx_list)">查看文档</a>
            </FormItem>
            <FormItem label="附件" style="width: 30%">
              <a @click="handleUpDetail(tableData[0].uploadList)">查看附件</a>
            </FormItem>
            <FormItem label="操作" style="width: 30%">
              <div style="width: 200px;">
                <Button type="warning" size="small" style="marginRight: 2px;"
                        @click="handlerSysUpdate(tableData[0],'post', '升级记录')">升级记录
                </Button>
                <Button type="info" size="small" style="marginRight: 2px;"
        ...
        <!--&lt;!&ndash;<Select v-model="searchKey" class="search-col">&ndash;&gt;-->
        <!--&lt;!&ndash;&lt;!&ndash;<Option v-for="item in columns"&ndash;&gt;&ndash;&gt;-->
        <!--&lt;!&ndash;&lt;!&ndash;v-if="item.key !== 'handle' && item.key !== 'status' && item.key !== ''"&ndash;&gt;&ndash;&gt;-->
        <!--&lt;!&ndash;&lt;!&ndash;:value="item.key" :key="`search-col-${item.key}`">{{ item.title }}&ndash;&gt;&ndash;&gt;-->
        <!--&lt;!&ndash;&lt;!&ndash;</Option>&ndash;&gt;&ndash;&gt;-->
        <!--&lt;!&ndash;<Option v-for="item in columns"&ndash;&gt;-->
        <!--&lt;!&ndash;v-if="item.key === 'sys_name'"&ndash;&gt;-->
        <!--&lt;!&ndash;:value="item.key" :key="`search-col-${item.key}`">{{ item.title }}&ndash;&gt;-->
        <!--&lt;!&ndash;</Option>&ndash;&gt;-->
        <!--&lt;!&ndash;</Select>&ndash;&gt;-->
        <!--&lt;!&ndash;<Input @on-change="handleClear" clearable placeholder="输入关键字搜索" class="search-input" v-model="searchValue"/>&ndash;&gt;-->
        <!--&lt;!&ndash;<Button @click="handleSearch" type="primary">搜索</Button>&ndash;&gt;-->
        <!--<Button-->
        <!--type="info"-->
        <!--class="search-btn"-->
        ...
        <!--<Table size="small" ref="selection" :columns="columns" :data="tableData" highlight-row-->
        <!--@on-row-click="showList"-->
        <!--&gt;-->
        <!--</Table>-->
        <!--</Card>-->
      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" inline label-colon=":">
        <FormItem style="width: 970px;">
          <Card :bordered="false">
            ...
            <FormItem label="版本号" prop="sys_version" style="width: 210px; margin-right: 20px; margin-bottom: 20px;">
              <Input v-model="formValidate.sys_version" :maxlength="50" placeholder="请填写版本号"></Input>
            </FormItem>
            <FormItem label="上线时间" prop="online_time" style="width: 210px; margin-bottom: 20px;">
            ...
            <FormItem label="开发单位" prop="development" style="width: 48%; margin-right: 20px;margin-bottom: 20px;">
            ...
            <FormItem label="开发单位联系人" prop="development_contact"
                      style="width: 210px; margin-right: 20px; margin-bottom: 20px;">
              <Input v-model="formValidate.development_contact" :maxlength="50" placeholder="请填写开发单位联系人"></Input>
            </FormItem>
            <FormItem label="开发单位联系电话" prop="development_phone"
            ...
            <FormItem label="系统简介" prop="sys_info"
                      style="width: 930px;height: 150px;margin-right: 20px;">
