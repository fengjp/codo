...
export default {
  ...
  methods: {
    ...
    allchangetable (data) {
      ...
      if (data.length > 0) { this.table_type_str = 'primary' } else { this.table_type_str = 'default' }
    ...
    allchangetable2 (data) {
      ...
      if (data.length > 0) { this.table_type_str2 = 'primary' } else { this.table_type_str2 = 'default' }
    ...
    getSpoonobjlist (department) {
      getSpoonobjlist(department).then(res => {
        if (res.data.code === 0) {
