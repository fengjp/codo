            ...
            <Row >
              <Col span="8" >
                ...
                ></Input>
                  ...
                  <Row >
                     <Col span="12" >
                <FormItem label="系统配置" prop="xtpeizhi" style="width:230px;">
                  <Input
                  :maxlength="45"
                  placeholder="请输入得分"
                  v-model="formValidate.xtpeizhi"
                ></Input>
                </FormItem>
                       </Col>
                    <Col span="12" >
                <FormItem label="评分说明" prop="xtpeizhi_remarks" style="width:260px;">
                  <Input
                  :maxlength="45"
                  placeholder="系统配置评分说明"
                  v-model="formValidate.xtpeizhi_remarks"
                ></Input>
                </FormItem>
                       </Col>
                   </Row >
...
import { meterList,meteradd ,rankinglist ,UploadUrl,UploadUrl2,getlinedata,getbjdata} from '@/api/task'
  ...
  data () {
    return {
      ...
      tableData: [
        ...
        {"toname":"系统建设运维保障","name":"软硬件设备配置","Symbol":"P1-3","branch":"5分","method":"对于应用服务器、数据库服务器、网络设备、互联网网络专线等资源不足，未配置云防护，影响互联网平台正常运行的，扣3分；对于未能及时按照部局系统建设要求，配置软硬件设备,完成系统建设的，扣5分。",
          },
        {"toname":"系统建设运维保障","name":"系统及时升级","Symbol":"P1-4","branch":"5分","method":"对于未能按照部局发文要求及时升级软件的，扣5分；对未能及时升级软件补丁的，每次扣3分，直至0分为止。",
          },
        {"toname":"系统建设运维保障","name":"系统配置","Symbol":"P1-5","branch":"5分","method":"各地应用服务器、数据库服务器、文件系统、短信网关、网络设备等参数配置是否正确。对于每次配置存在问题影响互联网平台功能使用的，扣3分。",
          },
        {"toname":"短信平台","name":"跨省短信发送支持","Symbol":"P1-6","branch":"5分","method":"各地互联网平台是否支持跨省手机号码短信发送。对于互联网平台对接的电信、移动、联通三大运营商均支持跨省短信发送的，得10分；对于两家运营商支持跨省短信发送的，得5分；其余得0分。",
          },
        {"toname":"短信平台","name":"短信发送成功率","Symbol":"P1-7","branch":"5分","method":"通过运行监控系统监测短信发送成功率情况。对于短信发送成功率在90%以上的，得5分；对于短信发送成功率每减少10%的，扣1分，直至0分为止。",
          },
        {"toname":"网上支付平台","name":"支付渠道","Symbol":"P1-8","branch":"10分","method":"对于支持银联、支付宝和微信中两个支付渠道的，得5分；对于支持支付宝、微信中任一支付渠道的，得3分；对于支持银联支付渠道的，得2分；不支持银联、支付宝、微信，但支持其他网上支付渠道的，得1分；其余得0分。",
          },
        {"toname":"网上支付平台","name":"支付项目","Symbol":"P1-9","branch":"10分","method":"对于支持驾驶人考试费支付项目的，得2分；对于支持机动车、驾驶证牌证工本费支付项目的，得2分；对于支持邮寄费支付项目的，得1分。",
          },
        {"toname":"网上支付平台","name":"退款支持","Symbol":"P1-10","branch":"5分","method":"对于支持交通违法罚款退款的，得5分；对于支持机动车、驾驶证牌证工本费退款的，得3分；对于支持考试费退款的，得2分。",
          },
        {"toname":"网上支付平台","name":"运行情况","Symbol":"P1-11","branch":"5分","method":"监测互联网平台请求网上支付平台的响应成功率，对于请求响应成功率达90%以上的，得3分；监测用户网上支付成功交易的平均操作时长，对于用户平均操作时长小于2分钟的，得5分；监测用户网上支付成功比率，对于成功比率大于90%的，得2分。",
          },
        {"toname":"数据交换","name":"内外网数据交换","Symbol":"P1-12","branch":"10分","method":"计算互联网测试数据包交换到公安网，公安网生成反馈数据再交换到互联网的总时长。对于平均总时长在5分钟以内的，得10分；对于平均总时长每增加1分钟的，扣2分，直至0分为止。对于交通违法证据图片未交换至互联网，用户无法查看的，扣5分。",
          },
        {"toname":"数据交换","name":"省际数据交换","Symbol":"P1-13","branch":"5分","method":"对于部级互联网平台与地方互联网平台通讯异常的总时长小于30分钟的，得5分；对于通讯异常每增加1至10分钟的，扣1分，直至0分为止。",
          },
  ...
  methods: {
    ...
    handleDetail (params) {
     ...
     handleSuccess (res, file) {
          ...
          this.rankinglist(this.start_date,this.end_date,2)
             },
    handleError (error) {
                // console.log(error)
                this.modalMap2.modalVisible = false
