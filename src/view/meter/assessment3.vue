...
<!--            <chart-bar2 :bar_data="bar_list" :value="barData" ref="childBar" style="width: 100%;height: 340px;" text=""/>-->
            <chart-line2 :keylist="line_list" :value="lineData" :legend="legend_list" ref="childLine" :setcolor="tocolor" :setname="to_setname" :weblist="weblist"  :applist="applist" style="width: 100%;height: 340px;" :text="to_setname"/>
        </div>
      </Card>
  </div>
</template>
      ...
      meterList(value).then(res => {
        if (res.data.code === 0) {
          ...
          for( let i=0;i < this.applist.length;i++){
              temp_list2.push(parseInt(this.applist[i]["longtimes"]))
