...
<!--        &lt;!&ndash;<alert>温馨提示：xxx</alert>&ndash;&gt;-->
...
<!--      </Form>-->
      <Form ref="formDynamic" :model="formDynamic" :label-width="80" style="width: 300px">
        ...
        <FormItem>
            <Row>
                <Col span="18">
                    <Input type="text" v-model="item.key" placeholder="请输入kye名"></Input>
                </Col>
              <Col span="18">
                    <Input type="text" v-model="item.type_name" placeholder="请输入字段自"></Input>
                </Col>
                <Col span="4" offset="1">
        ...
        <FormItem>
            <Row>
                <Col span="12">
                    <Button type="dashed" long @click="handleAdd" icon="md-add">增加字段</Button>
                </Col>
            </Row>
        </FormItem>
        <FormItem>
  ...
  export default {
    ...
    methods: {
      handleSubmit (name) {
            ...
            handleRemove (index) {
                this.formDynamic.dictvalue[index].status = 0;
