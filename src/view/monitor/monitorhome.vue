          ...
          <TabPane label="监控详情" name="name1">
            <i-col :lg="25" :md="24" style="margin-bottom: 10px;">
              <Card shadow>
                ...
                <!--              <Col span="24">-->
                <!--                <DatePicker :value="value2" @on-change="initBarCase" format="yyyy-MM-dd" placeholder="请选择日期范围"-->
                ...
                <!--              </Col>-->
                <!--            </Row>-->
<!--                <chart-line :keylist="keys" :value="lineCaseData" flag="1" ref="childCaseLine" style="height: 340px;"-->
<!--                            text="趋势图"/>-->
              </Card>
            </i-col>
            <i-col :lg="25" :md="24" style="margin-bottom: 10px;">
            ...
            <i-col :lg="25" :md="24" style="margin-bottom: 10px;">
              <Card shadow>
                <p style="font-size:20px">文件分区使用情况</p>
                <Table
                  :columns="columns"
                  :data="tableData"
                  id="table1"
            ...
            <i-col :lg="25" :md="24" style="margin-bottom: 10px;">
              <Card shadow>
                <p style="font-size:20px">网卡使用情况</p>
                <Table
                  :columns="columns2"
                  :data="tableData2"
                  id="table2"
            ...
            <Row>
              <i-col :lg="12" :md="24" style="margin-bottom: 10px;">
                <Card shadow>
                  <chart-line :keylist="keys" :value="lineCaseData" flag="1" ref="childCaseLine" style="height: 340px;"
                              text="cpu使用率"/>
                </Card>
              </i-col>
              <i-col :lg="11" :md="24" style="margin-bottom: 10px;margin-left: 30px;">
                <Card shadow>
                  <chart-line :keylist="keys" :value="lineCaseData" flag="1" ref="childCaseLine" style="height: 340px;"
                              text="内存使用率"/>
                </Card>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableData: [
          {"name":"/","size":"69.79GB","utilization_rate":"21.03%","capacity":"129.15GB","usedsize":"25.79GB"},
          {"name":"/boot","size":"0.25GB","utilization_rate":"8.65%","capacity":"0.59.15GB","usedsize":"0.79GB"},
          {"name":"/dev/shm","size":"69.79GB","utilization_rate":"51.03%","capacity":"129.15GB","usedsize":"125.79GB"}
        ],
        tableData2: [
          {"name":"eth0","Input_flow":"26.93KB","Input_package":"0个","Input_sum_package":"226个","output_flow":"7.55KB","output_package":"0个","output_sum_package":"38个","sum_flow":"34.63"},
          {"name":"eth1","Input_flow":"56.93KB","Input_package":"3个","Input_sum_package":"66个","output_flow":"7.55KB","output_package":"0个","output_sum_package":"38个","sum_flow":"34.63"},
          {"name":"eth2","Input_flow":"6.93KB","Input_package":"9个","Input_sum_package":"26个","output_flow":"7.55KB","output_package":"0个","output_sum_package":"38个","sum_flow":"34.63"},
        ],
