  ...
  methods: {
    ...
    getDictConfList () {
      getDictConfList().then(res => {
        if (res.data.code === 0) {
          const case_type_list = JSON.parse(res.data.data.case_type_list)
          const case_obj_list = JSON.parse(res.data.data.case_obj_list)
          const case_source_list = JSON.parse(res.data.data.case_source_list)
          const case_status_list = JSON.parse(res.data.data.case_status_list)
          const case_priority_list = JSON.parse(res.data.data.case_priority_list)
